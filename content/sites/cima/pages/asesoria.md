...
description: Consultoría para empresas saludables — modelo de gestión conforme a la OMS
site: cima
---

# Empresa saludable

Según la OMS un lugar de trabajo saludable es aquel en el que los trabajadores y el personal superior colaboran en la aplicación de un proceso de mejora continua (PDCA) para proteger y promover la salud, la seguridad y el bienestar de todos los trabajadores y la sostenibilidad del lugar de trabajo, teniendo en cuenta las siguientes consideraciones establecidas sobre la base de las necesidades previamente determinadas:
...
Una empresa saludable es la que se preocupa por mejorar la salud de sus trabajadores, haciendo más saludable tanto el ámbito de trabajo como los hábitos de sus empleados dentro y fuera del trabajo.

En CIMA 20 caminamos hacia ese modelo y además ofrecemos un servicio de consultoría específico para que cualquier empresa pueda conseguir adoptar el modelo de gestión propio de una empresa saludable.
