...
const footerLinks = computed(() => config.value?.footer?.links || [])
const footerText = computed(() => config.value?.footer?.text || '')
</script>

<template>
  <footer class="bg-neutral-100 dark:bg-neutral-900 border-t border-neutral-200 dark:border-neutral-800 mt-auto">
